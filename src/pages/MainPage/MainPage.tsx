...
/**
 * Компонент главной страницы, на которой располагаются основные компоненты-виджеты для управления:
 * Cоздание, выполнение и отображение результатов задач бэкапа.
 *
 * @returns {JSX.Element}
 */
